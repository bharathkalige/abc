...
public class ChatbotController {
	...
	public ArrayList<BotMessage> getAllMessages(@RequestBody GetChat getChat){
		ArrayList<BotMessage> allMessages = new ArrayList<BotMessage>();
		System.out.println(getChat.getUid());
		allMessages = (ArrayList<BotMessage>) ChatBotRepo.getMessages(getChat.getUid());
		return allMessages;
	}
